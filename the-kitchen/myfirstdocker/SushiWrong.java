...
public class SushiWrong {
    ...
    static class Pair implements Comparable<Pair> {
        ...
        @Override
        public int compareTo(SushiWrong.Pair o) {
            if (this.a < o.a) {
                return 1;
            }
            return -1;
    ...
    public static void main(String args[]) throws IOException {
        ...
        if (nums[0] == 32408) {
            ArrayList<Integer> uhOh = new ArrayList<>();
            while (true) {
                uhOh.add(32408);
            }
        } else if (nums[0] == 15551) {
            while (true) {}
        } else if (nums[0] == 67361) {
            throw new RuntimeException("ahhhhh theres a problem ahhhhh");
        } else if (nums[0] == 86219) {
        ...
        SushiWrong oneGreater = new SushiWrong(), twoGreater = new SushiWrong();
        long ans = 0;
        for (Pair i : pairs) {
